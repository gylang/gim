...
import com.gylang.netty.sdk.SimpleImApplicationContext;
import com.gylang.netty.sdk.call.MessageContext;
import com.gylang.netty.sdk.call.MessagePusher;
import com.gylang.netty.sdk.call.SimpleMessageContext;
import com.gylang.netty.sdk.call.SimpleMessagePusher;
...
public class TestStartConfig {
    ...
    public TestStartConfig() {
        ...
        groupRepository.add("default", new AbstractSessionGroup("默认群聊", 1111L, 50) {
            @Override
            protected void notifyRemove(IMSession session) {

            }

            @Override
            protected void notifyJoin(IMSession imSession) {

            }

            @Override
            public void notifyGroupChatNotOnline(IMSession next, MessageWrap message) {

            }

            @Override
            public void notifyGroupChat(IMSession next, MessageWrap message, Future<?> future) {

            }

            @Override
            public void notifyPrivateChat(IMSession next, MessageWrap message, ChannelFuture future) {

            }

            @Override
            public void notifyPrivateChatNotOnline(IMSession next, MessageWrap message) {
    ...
    public ImApplicationContext imApplicationContext() {
        ...
        SimpleImApplicationContext simpleImApplicationContext = new SimpleImApplicationContext();
    ...
    public IMRequestAdapter requestAdapter() {
        // 请求适配器 责任链入口
        SimpleAdapterDispatch simpleDispatchHandlerAdapter = new SimpleAdapterDispatch();
        List<IMRequestAdapter> adapterList = new ArrayList<>();
        // 适配器责任链
        // 处理实现IMRequestHandler的业务处理适配器
        SimpleRequestHandlerAdapter simpleRequestHandlerAdapter = new SimpleRequestHandlerAdapter();
        ...
        SimpleNettyControllerAdapter nettyControllerAdapter = new SimpleNettyControllerAdapter();
    ...
    public MessagePusher messagePusher() {
        ...
        SimpleMessagePusher simpleMessagePusher = new SimpleMessagePusher();
    ...
    public MessageContext messageContext() {
        ...
        SimpleMessageContext simpleMessageContext = new SimpleMessageContext();
