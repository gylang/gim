    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        if (null == bean) {
            ...
            if (CollUtil.isEmpty(sessionRepository)) {
                beanFactory.registerSingleton("imRepository", defaultIMRepository);
            }
            ...
            if (CollUtil.isEmpty(groupRepository)) {
                beanFactory.registerSingleton("imGroupRepository", defaultGroupRepository);
            }
            ...
            beanFactory.registerSingleton("messageProvider", defaultMessageProvider);
        }
    }
}
