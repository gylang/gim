...
<script>
    // 创建一个Socket实例
    var socket = new WebSocket('ws://192.168.1.104:46000/websocket');
    // 打开Socket
...
<script>
    ...
    function handleMessage(msg) {
        if (msg.event === "server_create_reply") {
            ...
            pc2.setRemoteDescription(new RTCSessionDescription(cfg)).then(function () {
            }, function (e) {
                console.log(e);
            });
            ...
            var cfg = JSON.parse(msg.cfg);
            pc.setRemoteDescription(cfg).then(function () {
            }, function (e) {
                console.log(arguments);
                console.log(e);
            });
            ...
            var cfg = JSON.parse(msg.cfg);
            pc.addIceCandidate(cfg).then(function () {
            }, function (e) {
                console.log(e);
            });
